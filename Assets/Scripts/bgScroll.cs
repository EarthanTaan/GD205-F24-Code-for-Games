...
public class bg_scroll : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        offset.x = GameObject.Find("Carrier").transform.position.x * xMod;             //slide the stars left and right in accordance with the ship's lateral motion.
